...
<?php ?>
<body class="hold-transition login-page" style="background:url(theme/dist/img/unnamed.jpg)
no-repeat center center fixed; background-size: cover;
 -webkit-background-size: cover;
 -moz-background-size: cover; -o-background-size: cover;"><div class="login-box">
  <div class="login-logo">
    <h2 style="color:white;"><strong>Website Aplikasi Poin Pelanggaran Siswa<br>SMKN 2 KOTA MOJOKERTO</h2></strong></a>
  </div>
  <!-- /.login-logo -->
