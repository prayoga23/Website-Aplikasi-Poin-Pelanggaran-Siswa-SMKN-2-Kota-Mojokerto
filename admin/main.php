      ...
      <div class="navbar-custom-menu">
        ...
        <?php }*/ ?>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img src="<?php echo $base; ?>php/img/imelisa.jpeg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $na['nama'] ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo $base; ?>php/img/imelisa.jpeg" class="img-circle" alt="User Image">
                <p>
                  <?php echo $na['nama']; ?>
                  <small></small>
                </p>
...
?>
      ...
      <ul class="sidebar-menu">
        ...
        <li <?php echo $fak; ?>>
          <a href="<?php echo $basead; ?>laporan">
...
?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="#">SMKN 2 KOTA MOJOKERTO</a></strong> by Imelisa Putri
  </footer>
  <!-- Control Sidebar -->
